...
између различитих захтева и одговора (сви захтеви и одговори се
сматрају независним једни од других). С обзиром на то да се у
...
након чега му се поново формулар за унос имена.
...
формулар читајући POST аргумент ``request.form["name"]``. Након
...
(који није HTML страница, већ само инструкција да се прегледач
...
Поново желимо да се након брисања колачића пребацимо на главну
страницу апликације, па се зато уместо помоћу функције
``render_template`` одговор формира помоћу функције ``redirect``.  Не
постоји посебна функција за брисање колачића -- уместо тога се колачић
може поново поставити тако да му је време истека једнако нули.

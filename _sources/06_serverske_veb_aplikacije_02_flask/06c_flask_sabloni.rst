...
можемо проширити тако да врати целокупну HTML страницу.
...
странице које ће се слати као одговор клијенту. Библиотека ``Flask``
...
странице настају на основу шаблона, природно је да свака таква страна
...
текст који се приказује на тим страницама, али је то у овом примеру,
...
Текст који би се приказивао на овим страницама би сада био уписан у
ова два шаблона.
...
заједнички за цео сајт или неколико његових страница наведе и одржава
само једном (у то обично спада укључивање CSS и JS датотека, заглавље
и подножје страница са логотипом, менијем за навигацију и слично).

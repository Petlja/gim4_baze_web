...
наведемо путању облика ``"/<ime>"``, то значи да ће декорисана функција
...
можемо га проследити шаблону који садржи HTML опис странице која
...
``"prikazi_proizvod/<int:id_proizvod>"``. Овим страницама би се тада

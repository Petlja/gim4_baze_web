...
костуру странице се може предвидети неки простор на ком ће се
...
Направићемо костур HTML странице у шаблону ``templates/index.html`` и
на почетку тела ћемо предвидети приказивање свих флешованих порука.
...
Њом постижемо да се вредност функције складишти у маведену променљиву

...
- Формат ниски које су допуштене у пољима за унос текста се може
  ...
  основних примера из којих ћете основну представу шта су и како се
  регуларни изрази користе.

  - ``a`` - означава један карактер и то баш ``a``
  - ``[a-z]`` - означава један карактер и то баш мало слово
  ...
  - ``ab?c`` - означава једну од две речи ``abc`` или ``ac`` (``?``
    означава да се нешто јавља опционо тј. нула пута или један пут)
...
у пољу у које је унета мејл адреса не може да постоји ништа осим онога
...
скупа карактера који садржи мала слова, цифре, подвлаку, тачкицу или
...
карактера који садржи мала слова, цифре, тачкицу или цртицу. Да би се
...
не сме да се поузда на то да су подаци које је примио коректни (јер је

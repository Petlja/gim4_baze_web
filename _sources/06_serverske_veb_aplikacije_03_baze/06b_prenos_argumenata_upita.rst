...
скрипту у склопу GET HTTP захтева. Страницу ћемо отварати помоћу
URL-ова облика ``http://127.0.0.1:5000/tracks?genre_id=3``, где је
``genre_id`` идентификатор жанра. Тада у главном скрипту можемо прво
проверити да ли се заиста кључ ``genre_id`` налази међу GET
аргументима. Ако се не налази, тада пријављујемо грешку. У супротном,
читамо вредност GET аргумента придружену том кључу (то је
...
Веб-страница која је одговор на овај захтев садржи или списак
...
приказује када се страница отвори у прегледачу веба.
...
именовани аргументи, они се додају као GET аргументи унутар URL-а који
се гради. Имајући то у виду, претходни шаблон је много боље
...
исти наслов странице и слично). Већ је речено да се овакво понављање

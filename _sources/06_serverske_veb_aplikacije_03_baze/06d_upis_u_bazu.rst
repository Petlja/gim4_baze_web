...
након тога се приказује страница која садржи информацију о томе да ли
је упис у базу био успешан или не и након тога формулар који омогућава
упис новог корисника.

Имајући ово у виду, можемо написати следећи шаблон странице.
...
прослеђује преко променљиве ``msg``. У првом делу странице се
проверава да ли је та променљива дефинисана и ако јесте, приказује се
њена вредност. На слици је приказан изглед странице након успешног
уписа корисника у базу.
...
Наредни део странице садржи формулар. Приметимо да је метода којом се

...
.. quizq::
    ...
    .. fillintheblank:: ogranicavanje_klauzula
        ...
        Коју клаузулу треба додати упиту да бисмо ово постигли? У одговору користи ВЕЛИКА СЛОВА.
...
.. quizq::
    ...
    .. mchoice:: ogranicavanje_mala_tabela
        ...
        :answer_b: Резултати се понављају у круг док се не добије тражени број редова.
